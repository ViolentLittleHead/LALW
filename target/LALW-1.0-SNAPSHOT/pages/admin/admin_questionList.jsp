                    ...
                    <div id="content_body">
                        <span style="float: left;padding-left: 50px;margin-bottom: 20px">
                                <form action="${pageContext.request.contextPath}/algorithm/upload" method="post" enctype="multipart/form-data" onsubmit="return check()">
                                    ...
                                    <span style="float:left;font-size: 15px;">
                                        提问：<input type="text" id="password" name="password" style="height: 40px;width: 200px;resize: none" >
                                    </span >
                                    <span style="float:left;font-size: 15px;padding-left: 100px">
                                        <input style="height: 40px;width: 150px;" id="replybtn" type="submit" value="发布" >
                                    </span>
                                </form>
                        </span>
                        <h4 class="box-body">
                                ...
                                <table width="1200px">
                                    ...
                                    <c:forEach items="${questionList}" var="question" varStatus="i" >
                                        <tr style="line-height: 30px">
                                            ...
                                            <td width="20px"> </td>
                                            <td width="200px">
                                                <fmt:formatDate value="${question.date}" type="both"></fmt:formatDate>
                                            </td>
                                            <td width="40px"></td>
                                            <td width="440px">
                                                ${question.content}
...
<script>
    ...
    function a1() {
        window.location.href="${pageContext.request.contextPath}/admin/questionList?currentPage=${currentPage-1}";
    }
    function a2(i) {
        window.location.href ="${pageContext.request.contextPath}/admin/questionList?currentPage="+i;
    }

    function a3() {
        window.location.href="${pageContext.request.contextPath}/admin/questionList?currentPage=${pages}";
    }
