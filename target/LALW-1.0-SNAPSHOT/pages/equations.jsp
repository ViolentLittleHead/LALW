...
<body class="hold-transition skin-purple sidebar-mini">
				...
				<section class="content"> <!-- .box-body -->
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">注意：一行元素用空格隔开，换行表示下一行(每行的首位不要有空格，行之间不要有空行)，右侧矩阵请使用换行隔开每个元素（竖着输入）</h3>
						</div>
						...
						<div align="center" style="width: 20%;height: 150px;float: left;margin: 20px;margin-top: 5%"><br><br><br><br>
							<input style="width:50%" type="button" onclick="toResult()" class="btn btn-default" value="计&nbsp;&nbsp;算"></input><br>
	...
	<script>
		function toResult() {
			$.ajax({
				url: '${pageContext.request.contextPath}/equations/toResult',
				type: 'post',
